        ...
        books.append(
            {
                ...
                "book_event_id": side.get("book_event_id") or side.get("event_id") or side.get("eventId"),
        ...
        books.append(
            {
                ...
                "book_event_id": book.get("book_event_id") or book.get("event_id") or book.get("eventId"),
...
def _plus_ev_book(item: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "book_event_id": bet.get("book_event_id") or bet.get("event_id") or bet.get("eventId"),
